...
#endif
#if UNITY_EDITOR
        //UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(gameObject, "Assets\Plugins\Init\Driver.cs (200,9)", "MogoInitialize");
        //UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(gameObject, "Assets\Plugins\Init\Driver.cs (201,9)", "TestUI");
#else
        if (SystemSwitch.ReleaseMode)
        {
