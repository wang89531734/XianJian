...
public class FightSceneManager
{
    ...
    private void InitFightCamera()
    {
        ...
        string text = this.m_BattleGroup.FightCamera;
        if (text == null)
        {
        ...
        //if (mainCamera == null)
        //{
        //    UnityEngine.Debug.Log("找不到MAIN_CAMERA");
        //    return;
        //}
        //CameraControlSystem.CopySSAO(this.m_FightCamera, mainCamera);
        //CameraControlSystem.CopySMAA(this.m_FightCamera, mainCamera);
        //CameraControlSystem.CopyImageEffect(this.m_FightCamera, mainCamera);
    }
    ...
    private void CreatePlayer()
    {
        ...
        {
            UnityEngine.Debug.Log(defaultFormationData.Unit[i].RoleID);
    ...
    //		else
    //		{
    //			m_Mob = (characterModel_Fight.AddComponent(data.MobData.ScriptName) as M_Mob);
    //		}
    ...
    //			text = array[0];
    //		}
    //		RuntimeAnimatorController animatorController_Fight = ResourceManager.Instance.GetAnimatorController_Fight(text);
    //		if (animatorController_Fight != null)
    //		{
    //			Animator component = characterModel_Fight.GetComponent<Animator>();
    //			if (component != null)
    ...
    //		}
    //		this.m_AppearCamPath = ResourceManager.Instance.GetFightObject(text);
    //		if (this.m_AppearCamPath == null)
    //		{
    //			return;
    //		}
