...
public class AnimCtrlScript : MonoBehaviour
{
    ...
    //	// (get) Token: 0x06001B46 RID: 6982 RVA: 0x000F4854 File Offset: 0x000F2A54
    ...
    //	// (get) Token: 0x06001B47 RID: 6983 RVA: 0x000F48E4 File Offset: 0x000F2AE4
    //	// (set) Token: 0x06001B48 RID: 6984 RVA: 0x000F48EC File Offset: 0x000F2AEC
    ...
    //	// (get) Token: 0x06001B49 RID: 6985 RVA: 0x000F48F8 File Offset: 0x000F2AF8
    //	// (set) Token: 0x06001B4A RID: 6986 RVA: 0x000F4900 File Offset: 0x000F2B00
    ...
    //	// Token: 0x06001B4B RID: 6987 RVA: 0x000F490C File Offset: 0x000F2B0C
    ...
    //			{
    //				Debug.Log("DLC_MoHuai GetOriActorName, just return XianQing back");
    //				return text;
    //			}
    ...
    //	// (get) Token: 0x06001B4C RID: 6988 RVA: 0x000F496C File Offset: 0x000F2B6C
    ...
    //	// Token: 0x06001B4D RID: 6989 RVA: 0x000F4974 File Offset: 0x000F2B74
    ...
    //	// Token: 0x06001B4E RID: 6990 RVA: 0x000F4A80 File Offset: 0x000F2C80
    //	public void Start()
    //	{
    //		if (this.hasInit)
    //		{
    ...
    //	// Token: 0x06001B4F RID: 6991 RVA: 0x000F4AB4 File Offset: 0x000F2CB4
    ...
    //	// Token: 0x06001B50 RID: 6992 RVA: 0x000F4ADC File Offset: 0x000F2CDC
    ...
    //	// Token: 0x06001B51 RID: 6993 RVA: 0x000F4B34 File Offset: 0x000F2D34
    ...
    //	// Token: 0x06001B52 RID: 6994 RVA: 0x000F4BA8 File Offset: 0x000F2DA8
    ...
    //	// Token: 0x06001B54 RID: 6996 RVA: 0x000F4E8C File Offset: 0x000F308C
    ...
    //	// Token: 0x06001B55 RID: 6997 RVA: 0x000F5008 File Offset: 0x000F3208
    ...
    //	// Token: 0x06001B56 RID: 6998 RVA: 0x000F50C0 File Offset: 0x000F32C0
    ...
    //	// Token: 0x06001B57 RID: 6999 RVA: 0x000F50E8 File Offset: 0x000F32E8
    ...
    //	// Token: 0x06001B58 RID: 7000 RVA: 0x000F5138 File Offset: 0x000F3338
    ...
    //	// Token: 0x06001B59 RID: 7001 RVA: 0x000F52C8 File Offset: 0x000F34C8
    ...
    //	// Token: 0x06001B5A RID: 7002 RVA: 0x000F5360 File Offset: 0x000F3560
    //	public void SetOverrideClip(AnimationClip clip, string animName)
    //	{
    //		this.overrideCtrl[animName] = clip;
    //	}

    //	// Token: 0x06001B5B RID: 7003 RVA: 0x000F5370 File Offset: 0x000F3570
    //	public static void ClearAnimClipsDic()
    //	{
    //		foreach (KeyValuePair<string, Dictionary<string, AnimClipData>> keyValuePair in AnimCtrlScript.AnimClipsDic)
    //		{
    //			foreach (KeyValuePair<string, AnimClipData> keyValuePair2 in keyValuePair.Value)
    //			{
    //				AnimClipData value = keyValuePair2.Value;
    //				value.Clear();
    //			}
    //		}
    ...
    //	// Token: 0x06001B5C RID: 7004 RVA: 0x000F5438 File Offset: 0x000F3638
    ...
    //	// Token: 0x06001B5D RID: 7005 RVA: 0x000F5634 File Offset: 0x000F3834
    ...
    //			{
    //				Debug.LogError(AnimName + "没有_Z动作！！！！");
    //				return null;
    //			}
    ...
    //	// Token: 0x06001B5E RID: 7006 RVA: 0x000F5814 File Offset: 0x000F3A14
    ...
    //	// Token: 0x06001B5F RID: 7007 RVA: 0x000F5890 File Offset: 0x000F3A90
    ...
    //	// Token: 0x06001B60 RID: 7008 RVA: 0x000F5930 File Offset: 0x000F3B30
    ...
    //		this.RestoreLayerWeights();
    //		this.animator.Play(this.tempHash, 0, this.curTime);
    //		int Layer = this.GetLayerNum(useUp);
    //		if (Layer > -1 && Layer < this.animator.layerCount)
    //		{
    //			if (this.m_bPlayFromBegining)
    //			{
    //				this.m_bPlayFromBegining = false;
    //				this.animator.CrossFade(anim.ToString(), crossTime, Layer, 0f);
    //			}
    //			else
    //			{
    //				this.animator.CrossFade(anim.ToString(), crossTime, Layer);
    //			}
    //		}
    //		else
    //		{
    ...
    //	// Token: 0x06001B61 RID: 7009 RVA: 0x000F5978 File Offset: 0x000F3B78
    ...
    //	// Token: 0x06001B62 RID: 7010 RVA: 0x000F59C4 File Offset: 0x000F3BC4
    ...
    //	// Token: 0x06001B63 RID: 7011 RVA: 0x000F5A08 File Offset: 0x000F3C08
    ...
    //	// Token: 0x06001B64 RID: 7012 RVA: 0x000F5B00 File Offset: 0x000F3D00
    ...
    //	// Token: 0x06001B65 RID: 7013 RVA: 0x000F5CDC File Offset: 0x000F3EDC
    ...
    //				{
    //					Debug.LogError("Error : AnimCtrlScript.CancelAnim  stateBoolName == null");
    //					return;
    //				}
    ...
    //	// Token: 0x06001B66 RID: 7014 RVA: 0x000F5DE8 File Offset: 0x000F3FE8
    ...
    //		foreach (KeyValuePair<int, ResetStateBool> keyValuePair in this.remainingRSBs)
    //		{
    //			if (keyValuePair.Value.SetFalse(this.animator))
    //			{
    //				this.NeedRemoveKey.Add(keyValuePair.Key);
    //			}
    //		}
    //		foreach (int key in this.NeedRemoveKey)
    //		{
    //			this.remainingRSBs.Remove(key);
    //		}
    //	}

    //	// Token: 0x06001B67 RID: 7015 RVA: 0x000F5EE8 File Offset: 0x000F40E8
    //	public IEnumerator ActiveAndSample(string stateBoolName, int LayerIndex = 0)
    //	{
    //		while (!AnimCtrlScript.IsActive(this.animator, stateBoolName, true))
    //		{
    //			yield return 0;
    //		}
    //		yield break;
    ...
    //	// Token: 0x06001B68 RID: 7016 RVA: 0x000F5F14 File Offset: 0x000F4114
    ...
    //		foreach (AnimatorClipInfo animatorClipInfo in list)
    //		{
    //			if (animatorClipInfo.clip.name.ToLower().Contains(stateBoolName))
    //			{
    //				result = true;
    //				break;
    //			}
    ...
    //	// Token: 0x06001B69 RID: 7017 RVA: 0x000F5FCC File Offset: 0x000F41CC
    ...
    //		}
    //		foreach (KeyValuePair<int, AnimatorClipInfo[]> keyValuePair in dictionary)
    //		{
    //			foreach (AnimatorClipInfo animatorClipInfo in keyValuePair.Value)
    //			{
    ...
    //	// Token: 0x06001B6A RID: 7018 RVA: 0x000F6118 File Offset: 0x000F4318
    ...
    //	// Token: 0x06001B6B RID: 7019 RVA: 0x000F6148 File Offset: 0x000F4348
