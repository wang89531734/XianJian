...
public class RendererTool
{
    ...
    //					transform.renderer.material = ResourceManager.Instance.GetMaterial(data.Materail[i].MaterailName);
    //				}
    //			}
    //		}
    //	}
    ...
    //		meshRenderer.sharedMaterial = ResourceManager.Instance.GetMaterial("AfterImage");
