...
public class GameTalk : ManagerBase, IDisposable
{
    ...
    public static void PlayStory(int mapid, string storyName)
    {
        ...
        //if (mapData != null)
        //{
        //    int mapID = Swd6Application.instance.m_GameDataSystem.m_MapInfo.MapID;
        ...
        //    if (Swd6Application.instance.m_ResourceType == ENUM_ResourceType.Develop)
        //    {
        //        UnityEngine.Debug.Log("HideAllNPC_" + mapID);
        //    }
        ...
        //    Swd6Application.instance.m_StorySystem.PlayStory(mapid, storyName);
        //}
    }

    public static IEnumerator IsPlayStoryEnd()
    {
        //while (!Swd6Application.instance.m_StorySystem.IsStoryEnd())
        //{
        //    yield return null;
        //}
        //int mapId = 0;
        //if (Swd6Application.instance.m_GameDataSystem.GetFlag(55))
        //{
        //    mapId = Swd6Application.instance.m_GameDataSystem.m_MapInfo.MapID;
        //    if (Swd6Application.instance.m_ExploreSystem.m_AutoHideMapID > 0)
        //    {
        //        mapId = Swd6Application.instance.m_ExploreSystem.m_AutoHideMapID;
        //    }
        //    Swd6Application.instance.m_GameObjSystem.HideObjByType2(mapId, ENUM_NpcType.Role, false);
        //    Swd6Application.instance.m_GameDataSystem.FlagOFF(55);
        //}
        //GameTalk.LockPlayer(true);
        //if (Swd6Application.instance.m_ResourceType == ENUM_ResourceType.Develop)
        //{
        //    Debug.Log("StoryEnd");
        //    if (!Swd6Application.instance.m_GameDataSystem.GetFlag(54))
        //    {
        //        Debug.Log("ShowAllNPC_" + mapId);
        //    }
        //}
        //Swd6Application.instance.m_ExploreSystem.m_AutoHideMapID = 0;
    ...
    /// 开始谈话
    /// </summary>
    /// <param name="bTalk"></param>
    public static void StartTalk(bool bTalk)
    {
        if (!bTalk)
        {
            if (GameEntry.ExploreSystem.PlayerController != null)
            {
                GameEntry.ExploreSystem.PlayerController.m_EnterTalkEvent = false;
            }
            //UI_TalkDialog.Instance.Close();//关闭UI对话
            //GameObject talkTarget = GameEntry.ExploreSystem.TalkTarget;
            //if (talkTarget != null)
            //{
    ...
    {
        GameEntry.ExploreSystem.LockPlayer = bLock;
    }
