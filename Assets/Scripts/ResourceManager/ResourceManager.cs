...
public class ResourcesManager
{
	...
	private ResourceLoader m_GUILoader;
	...
	public ResourcesManager()
	{
		...
		this.m_GUILoader = new ResourceLoader("/../Assetbundles/GUI/", "Assets/Assetbundles/GUI/GUI/", ".prefab");
	...
	{
		UnityEngine.Object resourceObj = this.m_GUILoader.GetResourceObj(name);
		if (resourceObj == null)
		{
			return null;
		}
		return resourceObj as GameObject;
	}
