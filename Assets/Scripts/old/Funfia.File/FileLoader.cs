	...
	public class FileLoader
	{
		public class AssetBundleLoader
		{
			...
			public event Action<UnityEngine.Object, string> OnLoadOver
			{
				...
				add
				{
					//this.OnLoadOver = (Action<UnityEngine.Object, string>)Delegate.Combine(this.OnLoadOver, value);
				}
				[MethodImpl(MethodImplOptions.Synchronized)]
				remove
				{
					//this.OnLoadOver = (Action<UnityEngine.Object, string>)Delegate.Remove(this.OnLoadOver, value);
				}
			}
			...
			public event Action<UnityEngine.Object, string> OnLoadOverInstantiate
			{
				...
				add
				{
					//this.OnLoadOverInstantiate = (Action<UnityEngine.Object, string>)Delegate.Combine(this.OnLoadOverInstantiate, value);
				}
				[MethodImpl(MethodImplOptions.Synchronized)]
				remove
				{
					//this.OnLoadOverInstantiate = (Action<UnityEngine.Object, string>)Delegate.Remove(this.OnLoadOverInstantiate, value);
				}
			}
			...
			//{
			//	FileLoader.AssetBundleLoader.<LoadBundle>c__Iterator17 <LoadBundle>c__Iterator = new FileLoader.AssetBundleLoader.<LoadBundle>c__Iterator17();
			//	<LoadBundle>c__Iterator.<>f__this = this;
			//	return <LoadBundle>c__Iterator;
			//}
		}
		...
		public static string LanguagePath
		{
			get
			{
				...
				{
					//FileLoader.s_languagePath = Path.Combine(Application.dataPath, Path.Combine("Langue", Langue.CurLangue.ToString()));
				}
		...
		//{
		//	FileLoader.<_loadAssetBundleFromFileAsync>c__Iterator15 <_loadAssetBundleFromFileAsync>c__Iterator = new FileLoader.<_loadAssetBundleFromFileAsync>c__Iterator15();
		//	<_loadAssetBundleFromFileAsync>c__Iterator.path = path;
		//	<_loadAssetBundleFromFileAsync>c__Iterator.<$>path = path;
		//	<_loadAssetBundleFromFileAsync>c__Iterator.<>f__this = this;
		//	return <_loadAssetBundleFromFileAsync>c__Iterator;
		//}

		//[DebuggerHidden]
		//public static IEnumerator LoadAssetBundleFromFileAsync(string path)
		//{
		//	FileLoader.<LoadAssetBundleFromFileAsync>c__Iterator16 <LoadAssetBundleFromFileAsync>c__Iterator = new FileLoader.<LoadAssetBundleFromFileAsync>c__Iterator16();
		//	<LoadAssetBundleFromFileAsync>c__Iterator.path = path;
		//	<LoadAssetBundleFromFileAsync>c__Iterator.<$>path = path;
		//	return <LoadAssetBundleFromFileAsync>c__Iterator;
		//}
