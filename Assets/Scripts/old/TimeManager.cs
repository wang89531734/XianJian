...
public class TimeManager : MonoBehaviour
{
	...
	//	//add
	//	//{
	//	//	this.selfUpdate = (Action)Delegate.Combine(this.selfUpdate, value);
	//	//}
	//	//[MethodImpl(MethodImplOptions.Synchronized)]
	//	//remove
	//	//{
	//	//	this.selfUpdate = (Action)Delegate.Remove(this.selfUpdate, value);
	//	//}
	//}
	...
	public static TimeManager Initialize()
	{
		...
		if (gameMain != null)
		{
			...
			//SaveManager.OnLoadOver -= new SaveManager.void_fun(TimeManager.instance.AutoSaveInit);
			//SaveManager.OnLoadOver += new SaveManager.void_fun(TimeManager.instance.AutoSaveInit);
			//ScenesManager.Instance.OnChangeMap -= new Action<int>(TimeManager.instance.RecordWeatherTime);
			//ScenesManager.Instance.OnChangeMap += new Action<int>(TimeManager.instance.RecordWeatherTime);
			//ScenesManager.Instance.OnLevelLoaded -= new Action<int>(TimeManager.instance.RecoverWeatherTime);
			//ScenesManager.Instance.OnLevelLoaded += new Action<int>(TimeManager.instance.RecoverWeatherTime);
	...
	{
		//TimeManager expr_05 = TimeManager.Initialize();
		//expr_05.selfUpdate = (Action)Delegate.Remove(expr_05.selfUpdate, new Action(TimeManager.instance.AutoSave));
		//TimeManager expr_2F = TimeManager.Initialize();
		//expr_2F.selfUpdate = (Action)Delegate.Combine(expr_2F.selfUpdate, new Action(TimeManager.instance.AutoSave));
