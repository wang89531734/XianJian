...
public abstract class M_GameRoleBase : MonoBehaviour
{
    ...
    //{
    //	M_GameRoleBase.<SetRoleQueuedMotion>c__Iterator9 <SetRoleQueuedMotion>c__Iterator = new M_GameRoleBase.<SetRoleQueuedMotion>c__Iterator9();
    //	<SetRoleQueuedMotion>c__Iterator.motionId = motionId;
    //	<SetRoleQueuedMotion>c__Iterator.motionId2 = motionId2;
    //	<SetRoleQueuedMotion>c__Iterator.<$>motionId = motionId;
    //	<SetRoleQueuedMotion>c__Iterator.<$>motionId2 = motionId2;
    //	<SetRoleQueuedMotion>c__Iterator.<>f__this = this;
    //	return <SetRoleQueuedMotion>c__Iterator;
    //}
